...
Table S2: Summary of linear regression of average minimum temperature between budburst and leafout before and after recent climate change across species. \\
Table S3: Summary of linear regression of number false springs before and after recent climate change across species. \\
