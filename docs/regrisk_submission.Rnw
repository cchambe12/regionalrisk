...
alnccz <- round((mean(fixef(long.full, pars="cc.z", summary=FALSE))+mean(fixef(long.full, pars="speciesALNGLU", summary=FALSE))), digits=2)
betccz <- round((mean(fixef(long.full, pars="cc.z", summary=FALSE))+mean(fixef(long.full, pars="speciesBETPEN", summary=FALSE))), digits=2)
fagccz <- round((mean(fixef(long.full, pars="cc.z", summary=FALSE))+mean(fixef(long.full, pars="speciesFAGSYL", summary=FALSE))), digits=3)
fraccz <- round((mean(fixef(long.full, pars="cc.z", summary=FALSE))+mean(fixef(long.full, pars="speciesFRAEXC", summary=FALSE))), digits=2)
queccz <- round((mean(fixef(long.full, pars="cc.z", summary=FALSE))+mean(fixef(long.full, pars="speciesQUEROB", summary=FALSE))), digits=2)
...
elevfivelong<-round((mean(fixef(fivelong.full, pars="elev.z", summary=FALSE))/4)/(sd(fsfivelong$elev)*2)*100*200, digits=2) ## 7.35
ccfivelong<-round((mean(fixef(fivelong.full, pars="cc.z", summary=FALSE))/4)/(sd(fsfivelong$cc)*2)*100, digits=2) ## 14.55
...
allfivelongcc<-round((allfivelongccstand/4)/(sd(fsfivelong$cc)*2)*100, digits=2)

### Okay now, we can calculate the interaction effects:
naoccfivelong<-round((mean(fixef(fivelong.full, pars="nao.z", summary=FALSE)+mean(fixef(fivelong.full, pars="nao.z:cc.z", summary=FALSE)))/4)/(sd(fsfivelong$nao)*2)*100*0.3, digits=2) 
matccfivelong<-round((mean(fixef(fivelong.full, pars="mat.z", summary=FALSE)+mean(fixef(fivelong.full, pars="mat.z:cc.z", summary=FALSE)))/4)/(sd(fsfivelong$mat)*2)*100*2, digits=2)
distccfivelong<-round((mean(fixef(fivelong.full, pars="dist.z", summary=FALSE)+mean(fixef(fivelong.full, pars="dist.z:cc.z", summary=FALSE)))/4)/(sd(fsfivelong$distkm)*2)*100*150, digits=2)
elevccfivelong<-round((mean(fixef(fivelong.full, pars="elev.z", summary=FALSE)+mean(fixef(fivelong.full, pars="elev.z:cc.z", summary=FALSE)))/4)/(sd(fsfivelong$elev)*2)*100*200, digits=2)
...
naolongtemps<-round((mean(fixef(longtemps.full, pars="nao.z", summary=FALSE))/4)/(sd(fslongtemps$nao)*2)*100*0.3, digits=2) ## 1.26
distlongtemps<-round((mean(fixef(longtemps.full, pars="dist.z", summary=FALSE))/4)/(sd(fslongtemps$distkm)*2)*100*150, digits=2) ## 2.75
elevlongtemps<-round((mean(fixef(longtemps.full, pars="elev.z", summary=FALSE))/4)/(sd(fslongtemps$elev)*2)*100*200, digits=2) ## 7.35
cclongtemps<-round((mean(fixef(longtemps.full, pars="cc.z", summary=FALSE))/4)/(sd(fslongtemps$cc)*2)*100, digits=2) ## 14.55
alllongtempsccstand<-((mean(fixef(longtemps.full, pars="cc.z", summary=FALSE)))+(mean(fixef(longtemps.full, pars="cc.z", summary=FALSE))+mean(fixef(longtemps.full, pars="speciesALNGLU", summary=FALSE)))+(mean(fixef(longtemps.full, pars="cc.z", summary=FALSE))+mean(fixef(longtemps.full, pars="speciesBETPEN", summary=FALSE)))+(mean(fixef(longtemps.full, pars="cc.z", summary=FALSE))+mean(fixef(longtemps.full, pars="speciesFAGSYL", summary=FALSE)))+(mean(fixef(longtemps.full, pars="cc.z", summary=FALSE))+mean(fixef(longtemps.full, pars="speciesFRAEXC", summary=FALSE)))+(mean(fixef(longtemps.full, pars="cc.z", summary=FALSE))+mean(fixef(longtemps.full, pars="QUEROB", summary=FALSE))))/6
alllongtempscc<-round((alllongtempsccstand/4)/(sd(fslongtemps$cc)*2)*100, digits=2)

### And now for the interaction effects
naocclongtemps<-round((mean(fixef(longtemps.full, pars="nao.z", summary=FALSE)+mean(fixef(longtemps.full, pars="nao.z:cc.z", summary=FALSE)))/4)/(sd(fslongtemps$nao)*2)*100*0.3, digits=2) 
matcclongtemps<-round((mean(fixef(longtemps.full, pars="mat.z", summary=FALSE)+mean(fixef(longtemps.full, pars="mat.z:cc.z", summary=FALSE)))/4)/(sd(fslongtemps$mat)*2)*100*2, digits=2)
distcclongtemps<-round((mean(fixef(longtemps.full, pars="dist.z", summary=FALSE)+mean(fixef(longtemps.full, pars="dist.z:cc.z", summary=FALSE)))/4)/(sd(fslongtemps$distkm)*2)*100*150, digits=2)
elevcclongtemps<-round((mean(fixef(longtemps.full, pars="elev.z", summary=FALSE)+mean(fixef(longtemps.full, pars="elev.z:cc.z", summary=FALSE)))/4)/(sd(fslongtemps$elev)*2)*100*200, digits=2)
