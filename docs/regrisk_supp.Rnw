...
print(xtable(modoutput, 
             caption = "Summary of Bernoulli model with the effects of species, climatic and geographical predictors on false spring risk.", label="tab:suppmodorig",
...
\newpage
<<label=suppmodfullleaf, results="asis", echo=FALSE, warning=FALSE, message=FALSE, fig.pos="H", fig.width=7, fig.height=4, fig.align='center'>>=
setwd("..//analyses/")

modoutput <- read.csv("output/fullleaf_full_modeloutput.csv", header=TRUE)
modoutput <- modoutput[c(1:47),]
#modoutput <- subset(modoutput, select=c("term", "estimate", "10%", "50%", "90%"))
# add multicolumn later for BB and LO headers above these column names
...
print(xtable(modoutput, 
             caption = "Summary of Bernoulli model of false spring risk during the first leaf to full leafout interval.", label="tab:suppmodfullleaf",
             align = c("l", "l", "r", "r","r","r", "r","r", "r")), #>{\\textit}l
      include.rownames=F, 
      caption.placement = "top", 
      #sanitize.text.function = function(x) {x}, table.placement="H",
...
print(xtable(modoutput, 
             caption = "Summary of Bernoulli model of false spring risk with varying rates of leafout for each species.", label="tab:suppmoddvr",
             align = c("l", "l", "r", "r","r","r", "r","r", "r")), #>{\\textit}l
      include.rownames=F, 
      caption.placement = "top", 
      #sanitize.text.function = function(x) {x}, table.placement="H",
