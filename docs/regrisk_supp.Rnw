...
<<label=simpregmods, results="asis", echo=FALSE, warning=FALSE, message=FALSE, , fig.pos="H", fig.width=7, fig.height=4, fig.align='center'>>=
...
print(xtable(bb[1:12,c(1:2,4:5)], caption = "Summary of simple linear regression model of day of budburst before and after climate change across species.",
...
print(xtable(tmin[1:12,c(1:2, 4:5)], caption = "Summary of simple linear regression model of average minimum temperature between budburst and leafout before and after climate change across species.",
             align = c("l", "l", "r","r","r")), #>{\\textit}l
      include.rownames=F,
      caption.placement = "top", 
      sanitize.text.function = function(x) {x}, table.placement="H")
...
print(xtable(lstfrz[1:12,c(1:2,4:5)], caption = "Summary of simple linear regression model of probability of false spring before and after climate change across species.",
             align = c("l", "l", "r","r","r")), #>{\\textit}l
      include.rownames=F, 
      caption.placement = "top", 
      sanitize.text.function = function(x) {x}, table.placement="H")
