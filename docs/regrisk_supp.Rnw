...
modoutput$term <- gsub(":speciesALNGLU", " by Alnus glutinosa", modoutput$term)
modoutput$term <- gsub(":speciesBETPEN", " by Betula pendula", modoutput$term)
modoutput$term <- gsub(":speciesFAGSYL", " by Fagus sylvatica", modoutput$term)
modoutput$term <- gsub(":speciesFRAEXC", " by Fraxinus excelsior", modoutput$term)
modoutput$term <- gsub(":speciesQUEROB", " by Quercus robur", modoutput$term)
