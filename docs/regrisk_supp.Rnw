...
bb$term <- gsub("speciesALNGLU", "Alnus glutinosa", bb$term)
bb$term <- gsub("speciesBETPEN", "Betula pendula", bb$term)
bb$term <- gsub("speciesFAGSYL", "Fagus sylvatica", bb$term)
bb$term <- gsub("speciesFRAEXC", "Fraxinus excelsior", bb$term)
bb$term <- gsub("speciesQUEROB", "Quercus robur", bb$term)
...
tmin$term <- gsub("speciesALNGLU", "Alnus glutinosa", tmin$term)
tmin$term <- gsub("speciesBETPEN", "Betula pendula", tmin$term)
tmin$term <- gsub("speciesFAGSYL", "Fagus sylvatica", tmin$term)
tmin$term <- gsub("speciesFRAEXC", "Fraxinus excelsior", tmin$term)
tmin$term <- gsub("speciesQUEROB", "Quercus robur", tmin$term)
...
lstfrz$term <- gsub("speciesALNGLU", "Alnus glutinosa", lstfrz$term)
lstfrz$term <- gsub("speciesBETPEN", "Betula pendula", lstfrz$term)
lstfrz$term <- gsub("speciesFAGSYL", "Fagus sylvatica", lstfrz$term)
lstfrz$term <- gsub("speciesFRAEXC", "Fraxinus excelsior", lstfrz$term)
lstfrz$term <- gsub("speciesQUEROB", "Quercus robur", lstfrz$term)
