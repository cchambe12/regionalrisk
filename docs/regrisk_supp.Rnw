...
print(xtable(modoutput, 
             caption = "Summary of Bernoulli model with the effects of species, climatic and geographical predictors on false spring risk.", label="tab:suppmodlongtemps",
...
{\begin{figure} [H]
  -\begin{center}
  -\includegraphics[width=16cm]{..//analyses/figures/APC_allpred_allspp_baseR_longtemps98.png}
...
print(xtable(modoutput, 
             caption = "Summary of Bernoulli model of false spring risk with -2.2$^{\circ}$C threshold for all species.", label="tab:suppmodlong",
             align = c("l", "l", "r", "r","r","r", "r","r", "r")), #>{\\textit}l
      include.rownames=F, 
      caption.placement = "top", 
      #sanitize.text.function = function(x) {x}, table.placement="H",
...
@
  ...
  {\begin{figure} [H]
  -\begin{center}
  -\includegraphics[width=12cm]{..//analyses/figures/model_output_98_dvrtemps.png}
...
modoutput <- read.csv("output/dvrtemps_full_modeloutput.csv", header=TRUE)
modoutput <- modoutput[c(1:47),]
#modoutput <- subset(modoutput, select=c("term", "estimate", "10%", "50%", "90%"))
# add multicolumn later for BB and LO headers above these column names
...
print(xtable(modoutput, 
             caption = "Summary of Bernoulli model of false spring risk with varying rates of leafout for each species.", label="tab:suppmoddvrtemps",
             align = c("l", "l", "r", "r","r","r", "r","r", "r")), #>{\\textit}l
      include.rownames=F, 
      caption.placement = "top", 
      #sanitize.text.function = function(x) {x}, table.placement="H",
