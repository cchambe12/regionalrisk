...
Simple regressions (Equation S1 and Equation S2) show budburst dates have advanced at a similar rate as last date of false spring temperatures (-2.2$^{\circ}$C), but the last date of false spring temperatures is after budburst suggesting false springs are still risks with climate change. These simple models, however, mask how consistent these changes are across species, and which climatic and geographical factors underlie this change.
