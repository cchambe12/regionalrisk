...
Simple regressions show budburst dates (Equation \ref{eq:2} and Equation \ref{eq:3}) have advanced at a similar rate as last date of false spring temperatures (-2.2$^{\circ}$C), but the last date of false spring temperatures is after budburst suggesting false springs are still risks with climate change. These simple models, however, mask how consistent these changes are across species, and which climatic and geographical factors underlie this change.

\begin{equation} \label{eq:2}
lm(\text{Day of Year} (Budburst) \~ \text{Climate Change} (scaled))
\end{equation}

\begin{equation} \label{eq:3}
lm(\text{Day of Year} (Last Freeze Date) \~ \text{Climate Change} (scaled))
\end{equation}
...
After climate change, there was less of a decreasing effect of risk at sites with higher mean spring temperatures and there was a slight increase in false spring risk after climate change at higher elevations (Figure S2 and Table S4). Thus, the results did not largely vary from the main model. 
