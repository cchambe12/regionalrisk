...
df$bb<-df$bb-6
df$lo<-df$bb + 12 ## was + 30 for Yann and Frederick 
...
write.csv(df, file="~/Documents/git/regionalrisk/analyses/output/bb_midleaf.csv", row.names=FALSE)
write.csv(dxx, file="~/Desktop/allspp_climateprep_midleaf.csv", row.names=FALSE)
