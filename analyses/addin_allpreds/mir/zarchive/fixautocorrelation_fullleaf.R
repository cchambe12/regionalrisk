...
bb<-read.csv("/n/wolkovich_lab/Lab/Cat/fs_allspp_fullleaf_allpred.csv", header=TRUE)
...
write.csv(prep_space, file="/n/wolkovich_lab/Lab/Cat/fs_newspace_fullleaf.csv", row.names=FALSE)
