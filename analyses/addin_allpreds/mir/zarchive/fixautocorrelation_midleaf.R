...
bb<-read.csv("/n/wolkovich_lab/Lab/Cat/fs_allspp_midleaf_allpred.csv", header=TRUE)
...
write.csv(prep_space, file="/n/wolkovich_lab/Lab/Cat/fs_newspace_midleaf.csv", row.names=FALSE)
