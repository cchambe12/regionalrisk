...
#bb<-read.csv("fs_allspp_dvrtemps_allpred.csv", header=TRUE)
bb<-read.csv("/n/wolkovich_lab/Lab/Cat/fs_allspp_dvrtemps_allpred.csv", header=TRUE)
...
write.csv(prep_space, file="/n/wolkovich_lab/Lab/Cat/fs_newspace_dvrtemps.csv", row.names=FALSE)
