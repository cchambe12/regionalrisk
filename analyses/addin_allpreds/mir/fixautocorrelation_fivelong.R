...
bb<-read.csv("/n/wolkovich_lab/Lab/Cat/fs_allspp_fivelong_allpred.csv", header=TRUE)
...
write.csv(prep_space, file="/n/wolkovich_lab/Lab/Cat/fs_newspace_fivelong.csv", row.names=FALSE)
