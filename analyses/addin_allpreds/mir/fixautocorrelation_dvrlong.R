...
bb<-read.csv("/n/wolkovich_lab/Lab/Cat/fs_allspp_dvrlong_allpred.csv", header=TRUE)
...
write.csv(prep_space, file="/n/wolkovich_lab/Lab/Cat/fs_newspace_dvrlong.csv", row.names=FALSE)
