...
bb<-read.csv("/n/wolkovich_lab/Lab/Cat/fs_allspp_longtemps_allpred.csv", header=TRUE)
...
write.csv(prep_space, file="/n/wolkovich_lab/Lab/Cat/fs_newspace_longtemps.csv", row.names=FALSE)
