...
#bb<-read.csv("fs_allspp_fullleaf_allpred.csv", header=TRUE)
bb<-read.csv("/n/wolkovich_lab/Lab/Cat/fs_allspp_midleaftemps_allpred.csv", header=TRUE)
...
write.csv(prep_space, file="/n/wolkovich_lab/Lab/Cat/fs_newspace_midleaftemps.csv", row.names=FALSE)
#write.csv(prep_space, file="~/Documents/git/regionalrisk/analyses/output/fs_newspace_fullleaf.csv", row.names=FALSE)
