...
\item By having different durations of vegetative risk for each species the magnitude and direction of the predictors remained consistent with the original model (Figure). %\ref{fig:orig})
...
{\begin{figure} [H]
  -\begin{center}
  -\includegraphics[width=14cm]{..//figures/BB_gis.png}
