...
\item The growing season is lengthening across many regions in the northern hemisphere [CITE], but false spring events still pose a threat in many of these regions \citep{Wypych2017}
