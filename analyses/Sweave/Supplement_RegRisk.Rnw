...
setwd("/Users/catchamberlain/Documents/git/regionalrisk/analyses/")
...
<<label=suppmodoutput, results="asis", echo=FALSE, warning=FALSE, message=FALSE, , fig.pos="H", fig.width=7, fig.height=4, fig.align='center'>>=
setwd("/Users/catchamberlain/Documents/git/regionalrisk/analyses/")
