...
We then took the residuals of that regression to use as our Y values in our eigenvector selection --- using a minimization of Moran's \textit{I} of the residuals \citep[][MIR]{Baumen2017}. We then took the calculated eigenvectors determined from the MIR approach and regressed these against the residuals from \ref{eg:s1}. The fitted values from this regression were used as the space parameter in our models.
