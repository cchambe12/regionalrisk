...
After 1983, all species initiated budburst around six days earlier on average (Figure \ref{fig:boxfs}A and Table SXX) and the minimum temperature between budburst and leafout was higher.  The average minimum temperature between budburst and leafout, however, varied across the six species with \textit{Betula pendula} and \textit{Aesculus hippocastanum} experiencing the lowest minimum temperatures (Figure \ref{fig:boxfs}B) and with \textit{Fraxinus excelsior} experiencing the greatest variation. There was wide variation across sites in false spring risk for each species and some species were more at risk of false springs after 1983 than others (Figure \ref{fig:boxfs}C). Although the increased risk seen for some species --- namely \textit{Fraxinus excelsior} --- could be due to environmental effects. Thus, species alone is not a sufficient predictor for false spring risk, spatial and climatic effects need to also be included to understand what drives false spring risk. 

\subsection*{The effects of climatic and spatial variation on false spring incidence}
The effects of the predictors varied in both direction and magnitude (Figure \ref{fig:maineffects}) for the overall model testing climatic and spatial variation in false spring risk. Mean spring temperature had the biggest effect (38.12\% decrease in probability) on the number of false springs, with warmer spring temperatures resulting is fewer false springs. More positive NAO indices, which generally advance budburst, slightly heightened the risk of false spring (+15.03\% probability). Individuals at sites further from the coast tend to have earlier budburst dates, which corresponded to an increased risk in false spring incidence (49.18\% increase in probability). Sites at higher elevations (20.92\% increase in probability) also had higher risks of false spring incidence, likely due to climatic effects. Overall, there were more false springs after 1983 (+41.91\% probability). 

Most of the interactions with increasing temperatures (i.e., the climate change predictor) exhibit a decreased risk in false springs, however, the probability of false spring incidence increased at sites with higher mean spring temperatures after 1983 (+52.20\% probability) (Figure \ref{fig:maineffects}). Warmer sites tend to have lower risks of false springs but with climate change, the risk isn't as low as before. There was a slight decreased risk in false springs further from the coast (-11.31\% probability) after climate change, potentially due to an even earlier advancement in budburst but the level of risk remained consistent before and after 1983 across elevations (+0.090\% probability), with false spring risk being higher at higher elevation. After climate change, the rate of false spring incidence largely decreased (-56.40\% probability) with increasing NAO indices -- again likely due to a large advancement in budburst. 
...
{\begin{figure} [H]
  -\begin{center}
  -\includegraphics[width=16cm]{..//figures/model_output_90.pdf}
