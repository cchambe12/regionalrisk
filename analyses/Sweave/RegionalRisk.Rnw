...
The effects of the predictors varied in both direction and magnitude (Figure \ref{fig:maineffects}) for the overall model testing climatic and spatial variation in false spring risk. Mean spring temperature had the biggest effect (-0.48 CAT-NEED TO CONVERT) on the number of false springs, with warmer spring temperatures resulting is fewer false springs. More positive NAO indices, which generally advance budburst, slightly heightened the risk of false spring (+0.14 CAT-NEED TO CONVERT). Individuals at sites further from the coast tend to have earlier budburst dates, which corresponded to an increased risk in false spring incidence (+0.40). Sites at higher elevations (+0.19) also had higher risks of false spring incidence, likely due to climatic effects. Overall, there were more false springs after 1983 (+0.35 CAT-NEED TO CONVERT). 

Most of the interactions with increasing temperatures (i.e., the climate change predictor) exhibit a decreased risk in false springs, however, the probability of false spring incidence increased at sites with higher mean spring temperatures after 1983 (+0.42) (Figure \ref{fig:maineffects}). Warmer sites tend to have lower risks of false springs but with climate change, the risk isn't as low as before. There was a slight decreased risk in false springs further from the coast (XX) after climate change, potentially due to an even earlier advancement in budburst but the level of risk remained consistent before and after 1983 across elevations (XX), with false spring risk being higher at higher elevation. After climate change, the rate of false spring incidence largely decreased (-0.83) with increasing NAO indices -- again likely due to a large advancement in budburst. 
