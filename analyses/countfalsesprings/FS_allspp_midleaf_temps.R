...
write.csv(x, file="/n/wolkovich_lab/Lab/Cat/allspp_data_midleaf_temps.csv", row.names=FALSE)
...
write.csv(allspp, file="/n/wolkovich_lab/Lab/Cat/fs_allspp_midleaf_temps.csv", row.names = FALSE)
