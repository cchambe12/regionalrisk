...
### Using -5 degC instead! Based on mean LT from Lenz 2013
...
write.csv(d, file="~/Documents/git/regionalrisk/analyses/output/fs_yearsitespp_5.csv", row.names = FALSE)
