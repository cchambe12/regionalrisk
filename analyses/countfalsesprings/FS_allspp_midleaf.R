...
write.csv(x, file="/n/wolkovich_lab/Lab/Cat/allspp_data_midleaf.csv", row.names=FALSE)
...
write.csv(allspp, file="/n/wolkovich_lab/Lab/Cat/fs_allspp_midleaf.csv", row.names = FALSE)
