...
five.short<-brm(fs ~ nao.z + mat.z + dist.z + elev.z + space.z +
...
save(five.short, file="/n/wolkovich_lab/Lab/Cat/five_short.Rdata")
...
five.full<-brm(fs ~ nao.z + mat.z + dist.z + elev.z + space.z +
                  cc.z + species + nao.z:species + 
                  mat.z:species + dist.z:species + elev.z:species + space.z:species + cc.z:species + 
                 nao.z:cc.z + mat.z:cc.z + dist.z:cc.z + elev.z:cc.z + space.z:cc.z +
