...
if(FALSE){
bb<-read.csv("/n/wolkovich_lab/Lab/Cat/fs_newspace_dvrtemps.csv", header=TRUE)
...
dvrtemps.full<-brm(fs ~ nao.z + mat.z + dist.z + elev.z + space.z +
                 cc.z + species + nao.z:species + 
...
save(dvrtemps.full, file="/n/wolkovich_lab/Lab/Cat/dvrtemps_full.Rdata")
