...
mod<-stan_glm(fs.count~ nao.z + mat.z + elev.z + space.z + dist.z +
                cc.z + species + nao.z:species + 
                mat.z:species + elev.z:species + space.z:species + cc.z:species + dist.z:species +
                nao.z:cc.z + mat.z:cc.z + elev.z:cc.z + space.z:cc.z + dist.z:cc.z, data=bb)
