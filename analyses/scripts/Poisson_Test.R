...
pois<-brm(fs.count~nao.z+mat.z+cc.z+elev.z+space.z+nao.z:cc.z + mat.z:cc.z + elev.z:cc.z +
                    space.z:cc.z + (1|species), 
                  data=bb.stan, prior=bprior1,cores=4, family=poisson)

save(pois, file="/n/wolkovich_lab/Lab/Cat/test_poisson.Rdata")