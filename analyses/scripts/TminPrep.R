...
aes$bb<-aes$lo-7 # Based on Danf's BETPAP - most closely related. Choose WL0 based on keeping all species consistent
...
fsyl$bb<-fsyl$lo-11 # Based on Danf's FAGGRA - most closely related. Choose WL0 based on keeping all species consistent
...
fex$bb<-fex$lo-6 # Based on Danf's FRANIG - most closely related. Choose WL0 based on keeping all species consistent
