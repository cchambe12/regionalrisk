### 14 July 2017 - Cat ###
## Make a Regional Risk Master file to calculate regional differences of false spring occurance ##
...
#write.csv(bb, file="~/Documents/git/regionalrisk/analyses/output/bbch_region_all.csv", row.names = FALSE)
...
#write.csv(dxx, "~/Documents/git/regionalrisk/analyses/output/master_events.csv", row.names=FALSE)
