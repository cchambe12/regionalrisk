# Let's try again... Acer psuedoplatanus
...
acepsu<-inner_join(dx, dxx, by=c("Date", "lat", "long"))
any.nas<-acepsu[is.na(acepsu$Tmin),]

write.csv(acepsu, file="~/Documents/git/regionalrisk/analyses/output/acepsu_data.csv", row.names=FALSE)
