...
# Regional Risk stuffs for Tilia cordata
...
bb<-read.csv("bbch_region_tilia.csv", header=TRUE)
...
#write.csv(dxx, "~/Documents/git/regionalrisk/analyses/output/tilia_events.csv", row.names=FALSE)
