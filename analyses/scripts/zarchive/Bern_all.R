...
berndvrfinal<-brm(fs ~ nao.z + mat.z + dist.z + elev.z + space.z +
...
save(berndvrfinal, file="/n/wolkovich_lab/Lab/Cat/elevdist_berndvrfinal.Rdata")

#poisfinalfive<-brm(fs.count ~ nao.z + mat.z + dist.z + elev.z + space.z +
 #                      cc.z + species + nao.z:species + 
  #                     mat.z:species + dist.z:species + elev.z:species + space.z:species + cc.z:species + 
   #                    nao.z:cc.z + mat.z:cc.z + dist.z:cc.z + elev.z:cc.z + space.z:cc.z, data=bb, chains=2,
...
#save(poisfinalfive, file="/n/wolkovich_lab/Lab/Cat/elevdist_poisfinalfive.Rdata")
