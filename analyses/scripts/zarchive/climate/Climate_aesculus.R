## 24 August 2017 - Cat
## Cleaning up Climate data for Aesculus hippocastanum
...
d<-read.csv("bbch_region_aesculus.csv", header=TRUE)
eur.tempmn <- nc_open(file.path("tn_0.25deg_reg_v15.0.nc"))
...
#write.csv(freezes, "~/Documents/git/regionalrisk/analyses/output/climate_aesculus.csv", row.names=FALSE, eol="\r\n")
