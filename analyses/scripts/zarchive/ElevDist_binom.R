...
mod.nb<-stan_glm(fs~ nao.z + mat.z + dist.z + space.z + elev.z +
                cc.z + species + nao.z:species + 
                mat.z:species + dist.z:species + space.z:species + elev.z:species + cc.z:species + 
                nao.z:cc.z + mat.z:cc.z + dist.z:cc.z + space.z:cc.z + elev.z:cc.z, data=bb, family=binomial(link="logit"), cores=4)


save(mod.nb, file="/n/wolkovich_lab/Lab/Cat/elevdist_binom.Rdata")
